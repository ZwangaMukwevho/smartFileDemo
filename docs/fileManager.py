...
class fileManager:
	...
	def obtainName(self,nameList):
		...
		:return: The name of file that URL in the nameList points to, if one of the parameters given are wrong it returns an empty string
		:rtype: string
		"""	
	...
	def obtainType(self,nameList):
		...
		:return: The type of file that URL in the nameList points to, if one of the parameters given are wrong it returns an empty string
		:rtype: string
		"""
	...
	def searchFile(self,fName):
		...
		:type fName: string
		:return: The name of result of searching for the file using `find` command on a linux terminal, if one of the parameters given are wrong it returns an empty string
		:rtype: string
		"""
	...
	def deleteFile(self,fName):
		...
		:type fName: string
		:return: The name of result of deleting for the file using `find` command on a linux terminal, if one of the parameters given are wrong it returns an empty string
		:rtype: string
		"""
